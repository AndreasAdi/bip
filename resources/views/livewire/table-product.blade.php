<div>
    <div wire:offline>
        <div
            class="w-full p-4 mt-2 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300"
            role="alert">
            <span class="font-medium">Warning!</span> You are offline.
        </div>
    </div>
    <div class="py-12">
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4 text-sm font-medium">
                                    ...
                                    <button onclick="deleteProduct({{ $item->id }})"
                                            class="text-red-600 hover:text-red-500">Delete
                                    </button>
                                </td>
