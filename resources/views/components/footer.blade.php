    ...
    <div class="w-full max-w-screen-xl p-4 py-6 mx-auto lg:py-8">
                ...
                <div class="mt-2">
                    ...
                    <div class="flex flex-row items-center space-x-2 text-gray-500"><span role="img"
                            aria-label="mail" class="text-xl anticon anticon-mail"><svg viewBox="64 64 896 896"
                                focusable="false" data-icon="mail" width="1em" height="1em" fill="currentColor"
                                aria-hidden="true">
                                <path
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <a href="https://www.facebook.com/bismacindoo/"
                ...
                <a href="https://www.linkedin.com/company/bismacindo"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 21 16">
                        <path fill-rule="evenodd"
                ...
                <a href="https://twitter.com/bismacindoo"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 20 17">
                        <path fill-rule="evenodd"
                ...
                <a href="https://www.instagram.com/bismacindo/"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
