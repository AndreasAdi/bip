        ...
        <form action="/admin/slide/update" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="title"
                    ...
                    placeholder="Judul Slide" name="title" required value="{{ $slide->title }}">
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea class="w-full border border-gray-300 rounded-lg bg-gray-50" name="description" id="description" cols="30"
                    rows="10">{{ $slide->description }}</textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <img src="{{ asset($slide->image) }}" alt="" class="w-1/2">
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="file" data-allow-reorder="true" data-max-file-size="3MB" class="filepond" name="bgimage"
                    id="bgimage">
                <img src="{{ asset($slide->bg_image) }}" alt="" class="w-1/2 ">
