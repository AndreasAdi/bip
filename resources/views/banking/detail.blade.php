...
<body>
    ...
    <main>
        <div class="grid grid-cols-1 gap-6 px-5 py-5 md:grid-cols-2 md:gap-12 lg:px-32 lg:py-16">
            ...
            <div class="px-12">
                <h1 class="text-3xl font-semibold">Money Counter GRG CM100V</h1>
                <div class="mt-3 mb-5">
                ...
                <p>
                    Based on the innovative cash sorting technology from GRGBanking, CM100V Series, the 1+1 compact
                    Banknote Sorting Machine, are the ideal cash counting and sorting solution for CITs, banks and
                    retailers.
                </p>
                ...
                <div>
                    - Professional and comprehensive banknote detection technology<br>
                    - OCR technology and double CIS (contact image scan)
                </div>
                <p class="mt-2 font-bold">
                    Optimum User Experience
                </p>
                <div>
                    - Large touch screen plus function keys;
                </div>
                <p class="mt-2 font-bold">
                    Specifications
                </p>
                <div>
                    - Fitness/denomination/version/orientation sorting <br>
                    - Sorting : 720 notes/ min<br>
                    - Counting 1,000 notes/ min<br>
                    - UV,IR,Visible light, Magnetic, OCR, CIS<br>
                    - RS-232, USB, LAN<br>
                    - Power Supply : AC90-240, 50/60HZ<br>
                    - Dimension : 310*310*394mm (W*H*D)<br>
                    - Weight : 13kg<br>
                </div>
                <button
