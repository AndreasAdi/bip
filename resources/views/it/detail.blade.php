    ...
    <main>
        <div class="grid grid-cols-1 gap-6 px-5 py-5 md:grid-cols-2 md:gap-12 lg:px-32 lg:py-16">
            ...
            <div class="px-12">
                ...
                <div>
                    <p>
                        The clean and simple commercial design of
                        the affordable HP 200 Pro 22 All-in-One PC
                        looks great in your workspace. Powerful
                        Intel® processors help you quickly get
                        through daily tasks and the 21.5-inch
                        diagonal display has plenty of room for
                        collaboration with co-workers.
                    </p>
                    <br>

                    <b class="font-bold">Processor</b> <br>
                    Intel® Core™ i5-10210U (up to 4.2 GHz with Intel® Turbo Boost Technology, 4 MB cache, 4 cores)
                    <br>
                    <b class="font-bold"> Operating System<br></b>
                    Windows 11 Pro 64 Bit
                    <br>
                    <b class="font-bold">Memory<br></b>
                    12GB DDR4 2666MHz (8+4GB)
                    <br>
                    <b class="font-bold">Storage (varian)<br></b>
                    1TB 7200 rpm SATA HDD
                    1TB HDD + 128GB PCIe NVMe M.2 SSD
                    1TB HDD + 256GB PCIe NVMe M.2 SSD
                    1TB HDD + 512GB PCIe NVMe M.2 SSD
                    <br>

                    <b class="font-bold">Graphics<br></b>
                    Intel® UHD Graphics
                    <br>

                    <b class="font-bold">Display<br></b>
                    21.5" diagonal, FHD (1920 x 1080), IPS, anti-glare, 250 nits, 45% NTSC
                    <br>
                </div>
                <button
        ...
        <div class="w-full max-w-screen-xl p-4 py-6 mx-auto lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    ...
                    <div class="mt-2">
                        <div class="flex flex-row mb-2 space-x-2 text-gray-500"><span role="img" aria-label="phone"
                                class="text-xl anticon anticon-phone"><svg viewBox="64 64 896 896" focusable="false"
                                    data-icon="phone" width="1em" height="1em" fill="currentColor"
                                    aria-hidden="true">
                                    <path
