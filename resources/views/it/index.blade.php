...
<body>
    ...
    <main>
        <div class="px-10 mt-5 ">
            <h1 class="mt-5 mb-3 text-2xl font-semibold text-center">IT Product</h1>
                ...
                <div class="transition-transform ease-in-out hover:scale-105">
                    <figure class="relative">
                        ...
                        <figcaption
                            ...
                            <p class="text-xl text-center">HP Pro 200 G4 AIO</p>
                        </figcaption>
                    </figure>
                </div>
                <div class="transition-transform ease-in-out hover:scale-105">
                    <figure class="relative">
                        <a href="#">
                            <img class="h-auto max-w-full p-5 rounded-lg" src="images/it/it2.webp" alt="">
                        </a>
                        <figcaption
                            class="absolute w-full px-4 py-1 text-lg text-white rounded-b-lg bottom-6 bg-gray-600/40">
                            <p class="text-xl text-center">Modern 15 A11SB</p>
                        </figcaption>
                    </figure>
                </div>
                <div class="transition-transform ease-in-out hover:scale-105">
                    <figure class="relative">
                        <a href="#">
                            <img class="h-auto max-w-full p-5 rounded-lg" src="images/it/it3.webp" alt="">
                        </a>
                        <figcaption
                            class="absolute w-full px-4 py-1 text-lg text-white rounded-b-lg bottom-6 bg-gray-600/40">
                            <p class="text-xl text-center">Epson L3110</p>
                        </figcaption>
                    </figure>
                </div>
                <div class="transition-transform ease-in-out hover:scale-105">
