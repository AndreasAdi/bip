...
<body>
    <div
        class="flex flex-col items-center justify-center h-screen text-3xl text-black align-middle transition-opacity duration-500 ease-in-out loading animate-fade-in">
