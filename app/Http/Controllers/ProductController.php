...
class ProductController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $product = Product::where("name", "like", "%" . $query . "%")->paginate(
            1
        );
        ...
        if (count($product) == 0) {
            ...
            $html .=
                '<th colspan="4" scope="row" class="px-6 py-16 font-medium text-center text-gray-600 whitespace-nowrap dark:text-white">Product Tidak Ditemukan</th>';
            $html .= "</tr>";
        }
        ...
        foreach ($product as $key => $value) {
            ...
            $html .=
                ...
                "</th>";
            $html .=
                '<td class="px-6 py-4 text-gray-500 whitespace-nowrap dark:text-gray-300">' .
                $value->getBrand->name .
                "</td>";
            $html .=
                '<td class="px-6 py-4 text-gray-500 whitespace-nowrap dark:text-gray-300">' .
